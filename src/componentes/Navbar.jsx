...
const Navbar = () => {
  return (
    <div>
      <nav className='w-[100%] h-24 sm:h-auto bg-[#01161E] border-b-2 border-[#eff6e0] flex justify-between shadow-md shadow-[#eff6e0] hover:shadow-md hover:shadow-[#39c8f7] px-10 sm:py-10 sm:px-0 md:w-auto lg:w-auto sm:flex sm:flex-col sm:gap-4 sm:items-center'>
