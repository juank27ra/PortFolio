  ...
  return (
    <footer className='bg-[#01161E] border-t-2 fixed bottom-0  border-[#eff6e0] h-14 flex justify-center w-[100%] sm:h-20 sm:items-center'>
      <div className="sm:w-1/3">
        ...
        <a target="_blank" href="https://www.linkedin.com/in/juan-carlos-ramirez-pinilla-a8518077/" className="text-sm text-[#eff6e0] p-4 ml-40 sm:ml-4 hover:text-blue-600 md:ml-20 ">LinkedIn </a>
