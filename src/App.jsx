...
export default function App() {
  const helmetContext = {};
  return (
    <HelmetProvider context={helmetContext}>    {/* el context ayuda a garantizar que el contexto nunca se encuentre fuera de la instancia actual de su aplicación */}
      <HashRouter>
        <Navbar/>
          <Routes>
            ...
            <>
              <Helmet>
                ...
                <meta name='description' content='Maquetación responsiva, desarrollo frontend ' />
            ...
            <>
              <Helmet>
                ...
                <meta name='description' content='Gmail, LinkedIn, Github, Whatsapp ' />
